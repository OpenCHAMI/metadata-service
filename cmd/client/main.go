...
var clusterdefaultsDeleteCmd = &cobra.Command{
	Use:   "delete [uid]",
	Short: "Delete a ClusterDefaults",
	Args:  cobra.ExactArgs(1),
	RunE: func(cmd *cobra.Command, args []string) error {
		c, err := getClient()
		if err != nil {
		...
		if err := c.DeleteClusterDefaults(ctx, args[0]); err != nil {
			return fmt.Errorf("failed to delete ClusterDefaults: %w", err)
		}
...
var instanceinfoDeleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := c.DeleteInstanceInfo(ctx, args[0]); err != nil {
			return fmt.Errorf("failed to delete InstanceInfo: %w", err)
		}
