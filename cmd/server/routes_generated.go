...
func RegisterGeneratedRoutes(r chi.Router) {
	...
	r.Group(func(protected chi.Router) {
		...
		protected.Route("/clusterdefaultss", func(r chi.Router) {
		...
		// InstanceInfo routes
		protected.Route("/instanceinfos", func(r chi.Router) {
		...
		// Profile routes
		protected.Route("/profiles", func(r chi.Router) {
			r.Get("/", GetProfiles)
		...
		protected.Route("/wireguardpeers", func(r chi.Router) {
