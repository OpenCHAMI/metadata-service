...
install -d %{buildroot}/usr/share/containers/systemd/metadata-service.container.d
install -m 644 metadata-service.container.d/10-defaults.conf \
    %{buildroot}/usr/share/containers/systemd/metadata-service.container.d/
