...
// WireGuardPeer defines a userspace WireGuard peer managed via Fabrica.
type WireGuardPeer struct {
	resource.Resource
	Spec   WireGuardPeerSpec   `json:"spec" validate:"required"`
...
func init() {
	...
	resource.RegisterResourcePrefix("WireGuardPeer", "wgp")
}
