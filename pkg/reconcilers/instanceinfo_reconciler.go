...
// This file contains user-customizable reconciliation logic for InstanceInfo.
//
...
// reconcileInstanceInfo contains custom reconciliation logic.
//
// This method is called by the generated Reconcile() orchestration method.
// Implement InstanceInfo-specific reconciliation logic here.
//
// Guidelines:
...
//   - res: The InstanceInfo resource to reconcile
//
// Returns:
//   - error: If reconciliation failed (will trigger retry with backoff)
func (r *InstanceInfoReconciler) reconcileInstanceInfo(ctx context.Context, res *v1.InstanceInfo) error {
	// TODO: Implement InstanceInfo-specific reconciliation logic
	//
	// Example:
	//
	...
	//       eventType := "io.openchami.inventory.instanceinfos.connected"
	...
	r.Logger.Infof("InstanceInfo reconciliation not yet implemented for %s", res.GetUID())
